    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto pl-4 pr-8">
        ...
        <div class="hidden w-full md:block md:w-auto" id="navbar-multi-level">
            <ul
                ...
                <li>
                    <a href="#"
                        class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 md:dark:hover:bg-transparent">Contacto</a>
                </li>
                <li>
                    <a href="#"
                        class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 md:dark:hover:bg-transparent">Sobre nosotros</a>
                </li>
                @guest
