        ...
        <div class="flex justify-center mt-10">
            <div class="grid grid-cols-1 content">
                <a href="{{ route('pagar.paypal', $plan->id) }}"
                    class="w-72 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-lg px-2 py-2.5 text-center">
                    Contratar</a>
            </div>
        </div>
    </div>
