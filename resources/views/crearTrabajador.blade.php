...
@section('content_header')
    ...
    <br>
    <h1>¿A quien quieres dar de alta como trabajador?</h1>
@stop
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                    <h3 class="text-xl font-semibold text-gray-900 dark:text-white">
                        Rellena los campos del trabajador
                    </h3>
                    <button type="button"
                ...
                <div class="p-4 md:p-5">
                    <form id="form-existe" action="/admin/almacenar-trabajador" method="POST" class="md:space-y-6">
                        ...
                        <div id='titulo'>
                            <label for="titulo"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Titulación</label>
                            <input type="text" name="titulacion" id="titulo"
                        ...
                        <div id='especialidad'>
                            ...
                            <input type="text" name="especializacion" id="especialidad"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white">
                        </div>
